  ...
  return (
    ...
    >
      <Body className={Classes.DIALOG_BODY}>
        {user && (
          <>
            <Image src={user.avatar} alt="avatar" gender={user.gender} style={{height: '400px', width: '400px', margin: 0}} />
            <h2>{user.firstName} {user.lastName} <Gender icon={user.gender === 'male' ? faMars : faVenus} gender={user.gender} /></h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, eveniet, vel nemo vero quia ratione eum sit aspernatur ipsam sunt sed alias atque pariatur itaque?</p>
          </>
        )}
      </Body>
    </Dialog>
